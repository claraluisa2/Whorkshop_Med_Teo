DROP TABLE IF EXISTS sandbox.med.abt_churnC;
CREATE TABLE IF NOT EXISTS sandbox.med.abt_churnC AS
...
tb_clientes_fl AS (
    ...
    FROM sandbox.med.fs_transacoesC AS t1
...
LEFT JOIN sandbox.med.fs_transacoesC AS t2
ON t1.idCliente = t2.idCliente
AND t1.dtRef = t2.dtRef

LEFT JOIN sandbox.med.fs_ptosClara AS t3
